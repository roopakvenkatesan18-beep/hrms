...
DROP POLICY IF EXISTS "users_select_own_conversations" ON employee_chat_conversations;
...
DROP POLICY IF EXISTS "users_insert_conversations" ON employee_chat_conversations;
...
DROP POLICY IF EXISTS "users_select_messages" ON employee_chat_messages;
...
DROP POLICY IF EXISTS "users_insert_messages" ON employee_chat_messages;
