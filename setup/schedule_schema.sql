...
DROP POLICY IF EXISTS "employees_select_own_schedule" ON public.employee_schedule_slots;
...
DROP POLICY IF EXISTS "employees_insert_own_schedule" ON public.employee_schedule_slots;
...
DROP POLICY IF EXISTS "employees_delete_own_schedule" ON public.employee_schedule_slots;
...
DROP POLICY IF EXISTS "hr_select_all_schedules" ON public.employee_schedule_slots;
